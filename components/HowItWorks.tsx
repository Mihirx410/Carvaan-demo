export default function HowItWorks() {
    const logoColor = '#E91E63'; 
    const darkPurple = '#6B21A8';
  
    // Polaroid-style rotations per card
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div key={index} className="flex justify-center">
                ...
                <div
                  className="
                    ...
                    shadow-[0px_12px_35px_rgba(0,0,0,0.18)]
                    hover:shadow-[0px_15px_40px_rgba(0,0,0,0.22)]
                ...
                >
                  ...
                  >
                    <h3 className={`text-xl md:text-2xl font-bold mb-3 ${step.textColor}`}>
                      {step.title}
                    </h3>
                    {step.icon}
                  </div>
                  ...
                  <div className="px-4 py-3 bg-white">
                    <p className="text-black text-xs md:text-sm text-center leading-tight">
                      {step.description}
                    </p>
                  </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              className="text-white px-8 py-3 rounded-lg font-medium transition-opacity hover:opacity-90"
